...
//     * @throws InterruptedException thrown on interruption
     */
    ImmutableList<Profile> findAllByName(Iterable<String> names);
...
//     * @throws InterruptedException thrown on interruption
     */
    void findAllByName(Iterable<String> names, Predicate<Profile> consumer);
...
//     * @throws InterruptedException thrown on interruption
     */
    ImmutableList<Profile> findAllByUuid(Iterable<UUID> uuids);
...
//     * @throws InterruptedException thrown on interruption
     */
    void findAllByUuid(Iterable<UUID> uuids, Predicate<Profile> consumer);
