 ...
 */
public final class HashMapService extends SingleRequestService {
    ...
    public void put(Profile profile) {
        this.nameToIdMap.put(profile.name().toLowerCase(Locale.US), profile.uniqueId());
        this.idToNameMap.put(profile.uniqueId(), profile.name().toLowerCase(Locale.US));
    }
